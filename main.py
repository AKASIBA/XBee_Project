...
drv.append("""<p><button class="button" name="button" value='02' type="submit" id="button"><strong>開</strong></button>""")
...
drv.append(""">exe_dict['everyday'] = '{:0>2}'.format(form.getvalue('everyday')) if form.getvalue('everyday')else '10' @@""")
